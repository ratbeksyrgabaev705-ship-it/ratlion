(function () {
    ...
    const STRINGS = {
        ky: {
            ...
            address: 'Дарегиңиз',
            addressPlaceholder: 'Мисалы: Токtogul 120, квартира 15',
            selectOnMap: 'Даректи жазуу',
            ...
            mbPromoTitle: 'ДААМЫ СЕНИН ТАНДООҢ!<br><em>MBURGER</em>',
            mbPromoSub: 'ДААМДУУ · ТЕЗ · САПАТТУУ — Базар-Коргонго чейин',
        ...
        ru: {
            ...
            phone: 'Телефон',
            address: 'Адрес',
            addressPlaceholder: 'Например: Токtogul 120, квартира 15',
            selectOnMap: 'Указать адрес',
            myLocation: 'Моё местоположение',
            lastAddress: 'Последний адрес',
            addressPickTitle: 'Адрес',
            addressLoading: 'Определяем адрес…',
            apartment: 'Квартира / Подъезд',
            apartmentPlaceholder: 'Например: 12, 3-й подъезд',
            courierComment: 'Комментарий курьеру',
            courierCommentPlaceholder: 'Например: красные ворота',
            confirmAddress: 'Подтвердить адрес',
            gpsOffHint: 'GPS выключен. Включите геолокацию или перетащите карту.',
            gpsDenied: 'Нет доступа к геолокации. Перетащите карту для выбора адреса.',
            errAddressPick: 'Выберите адрес на карте',
            ...
            mbPromoTitle: 'ВКУС — ТВОЙ ВЫБОР!<br><em>MBURGER</em>',
            mbPromoSub: 'ВКУСНО · БЫСТРО · КАЧЕСТВЕННО — по Базар-Коргон',
            bmDelivery: '30-60 мин',
