(function () {
    ...
    const STRINGS = {
        ky: {
            ...
            foodCommentPlaceholder: 'Мисалы: пиязы аз, кок чөп кошпоңуз',
            ...
            recipientLabel: 'Алуучу: Ратбек С.',
            ...
            jolchuContact: 'Жолчу жеткирүү сервиси сиз менен байланышат.',
        ...
        ru: {
            ...
            recipientLabel: 'Получатель: Ратбек С.',
            ...
            jolchuContact: 'Служба доставки Жолчу свяжется с вами.',
